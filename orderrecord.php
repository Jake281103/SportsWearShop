...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Sixty9 | Order Record Page</title>
        <!-- Favicon -->
                        ...
                        <div class="col-lg-3 col-md-4 border userleftsidebars">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 border-bottom py-3 ps-5 bordersuccesses">
                                    <a href="./orderrecord.php" class="nav-link text-primary">
                                ...
                                <div class="col-lg-10 col-md-11 ">
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-0 py-1">
                                            <p class="text-secondary">Home > <span class="fw-bold"> My Order</span></p>
                                        </div>
                                                ...
                                                <div class="card-body d-flex justify-content-center align-items-center">
                                                    <table class="table table-hover mt-4 mb-4">
                                                        <tr class="fw-bold table-secondary ">
                                                            <td scope="col" class="pl-3">Order ID</td>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td scope="row" class="py-3 pl-3">OID<?php echo $order['id'] ?></td>
                                                                <td class="py-3"><span class="bg-success small text-white fw-bold rounded p-1">Delivered</span></td>
                                                                <td class="text-danger py-3">$<?php echo $order['totalprice'] ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                        <tr>
                                                            <td scope="row" class="py-3 pl-3"></td>
                                                            <td class="text-danger fw-bold py-3">Total Order</td>
