...
<body style="background-image: url('assets/images/img/loginbg.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;">
        
    <main class="main" style="background:transparent;">
        <div class="login-page bg-image pt-9 pb-8" style="background:transparent;">
        	<div class="container">
