...
<head>
    ...
    <meta charset="utf-8">
    <title>Sixty9 | Admin Register</title>
    <!-- Favicon -->
...
<body class="bg-gradient-primary" style="overflow:hidden;">
    ...
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <form class="user mb-5" action="./adminsignup.php" method="POST">
        ...
        <?php 
		if(isset($_SESSION['admin_email_exist'])){  
			$errormessage = $_SESSION['admin_email_exist'];
        ...
        <?php
        	unset($_SESSION['admin_email_exist']);
