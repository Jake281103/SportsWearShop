...
// this function take the last products
...
// this function get the number of products in each type 
                                    ...
                                    <?php foreach($lastproducts as $lastproduct){ ?>
                                        <div class="product product-3 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="./productdetail.php?pid=<?php echo $lastproduct['id'] ?>"><?php echo $lastproduct['name'] ?></a></h3><!-- End .product-title -->
                ...
                <div class="container">
                    <div class="cta cta-horizontal cta-horizontal-box bg-image mb-4 mb-lg-6" style="background-image: url(assets/images/demos/demo-10/bg-1.jpg);">
                        <div class="row flex-column flex-lg-row align-items-lg-center">
                            ...
                            <div class="col-auto">
                                <a href="./product.php" class="btn btn-white-primary btn-round"><span>Add to Cart for $50.00/yr</span><i class="icon-long-arrow-right"></i></a>
                            </div><!-- End .col-auto -->
                        </div><!-- End .row -->
